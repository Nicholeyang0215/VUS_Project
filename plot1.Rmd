...
```{r }
setwd("/Users/nicholeyang/Desktop/research2/VUS_paper/Result_plot")
...
############### Density function estimation ###########
  x1 = pos$carrier_prob ###positive carrier probabilities 
  x2 = neg$carrier_prob ###negative carrier probabilities 
  x3 = VUS$carrier_prob  
...
legend("topright",legend = c("Positive", "Negative","VUS"), col = c(1:3), pch = 20)
 ...
 ############### Density function estimation ###########
lx1 = log(pos$carrier_prob/(1-pos$carrier_prob)) ###positive carrier probabilities 
lx2 = log(neg$carrier_prob/(1-neg$carrier_prob)) ###negative carrier probabilities 

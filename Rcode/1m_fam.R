...
setwd('/n/home06/yy180/Revision/family_data')
...
############
  fam.id = c(1:sample_size)
  res.all = cbind(fam.id, proband, carrier_prob)
  res.sub = res.all[, c('fam.id','BRCA1','BRCA2','carrier_prob')]
  
save(res.sub, file=paste0("/n/home06/yy180/Revision/family_data/1m_families/fam_", script_num, ".RData"))
